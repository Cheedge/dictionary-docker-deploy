...
class Config(object):
	...
	SQLALCHEMY_DATABASE_URI="mysql+pymysql://root:Mysql_666@172.21.0.3:3306/Dictionary"
...
cache_config = {
	...
	"CACHE_REDIS_HOST": "172.21.0.4",
	"CACHE_REDIS_PORT": "6379",
	"CACHE_REDIS_PASSWORD": "redis666", # compared with "requirepass" in redis.conf 
}
cluster_cache_config = {
    "DEBUG": True,          # some Flask specific configs
    "CACHE_TYPE": "RedisClusterCache",  # Flask-Caching related configs
    "CACHE_DEFAULT_TIMEOUT": 600,
	"CACHE_REDIS_CLUSTER": "172.17.0.5:6379,172.17.0.6:6379,172.17.0.7:6379,172.17.0.8:6379,172.17.0.9:6379,172.17.0.10:6379",
}
